const en = {
    ...
    subject: 'Subject',
    sender: 'Sender',
    senderPrefixPlaceholder: 'Mailbox prefix',
    senderDomainPlaceholder: 'Sendable suffix',
    senderSelectPlaceholder: 'Select sender mailbox',
    noSendableSenderMsg: 'No available sender address. Please check send-enabled domains.',
    previewMailbox: 'Preview mailbox',
    createPreviewMailbox: 'Create preview mailbox',
    previewLink: 'Preview link',
    copyLink: 'Copy link',
    expireTime: 'Expire time',
    days: 'Days',
    currentExpire: 'Current expire time',
    expireInDays: 'Expires in {days} days',
    permanent: 'Permanent',
    selectDate: 'Select date',
    previewExpireInvalid: 'Invalid expiration time',
    loadMore: 'Load more',
    previewEmail: 'Mailbox preview',
    previewInvalid: 'Preview link is invalid',
    previewEmailManage: 'Preview email',
    shareEmailPreview: 'Share email preview',
    shareEmailPreviewTip: 'This link only shows the email content, without sender or recipient info.',
    user: 'User',
    ...
    addOutlookAccount: 'Add Outlook Account',
    changeOutlookAccount: 'Change Outlook Account',
    noOutlookAccount: 'No Outlook account',
    outlookAccountStringPlaceholder: 'Format: email----password----client_id----refresh_token',
