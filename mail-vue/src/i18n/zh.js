const zh = {
    ...
    subject: '主题',
    sender: '发件人',
    senderPrefixPlaceholder: '邮箱前缀',
    senderDomainPlaceholder: '发件后缀',
    senderSelectPlaceholder: '请选择发件邮箱',
    noSendableSenderMsg: '暂无可用的发件邮箱，请检查已配置的发件后缀',
    previewMailbox: '预览邮箱',
    createPreviewMailbox: '创建预览邮箱',
    previewLink: '预览链接',
    copyLink: '复制链接',
    expireTime: '有效时间',
    days: '天数',
    currentExpire: '当前有效期',
    expireInDays: '将在 {days} 天后过期',
    permanent: '永久',
    selectDate: '选择时间',
    previewExpireInvalid: '无效的过期时间',
    loadMore: '加载更多',
    previewEmail: '邮箱预览',
    previewInvalid: '预览链接无效',
    previewEmailManage: '预览邮件',
    shareEmailPreview: '分享邮件预览',
    shareEmailPreviewTip: '此链接仅展示邮件内容，不包含发件人与收件人信息。',
    user: '用户',
    ...
    regKey: '注册码',
    noCodeFound: '没有任何注册码',
    addOutlookAccount: '添加 Outlook 账号',
    changeOutlookAccount: '修改 Outlook 账号',
    noOutlookAccount: '还没有 Outlook 账号',
    outlookAccountStringPlaceholder: '账号格式：邮箱----密码----client_id----refresh_token',
    testConnection: '测试连接',
    testSuccess: '连接成功',
    junkEmail: '垃圾邮件',
    deletedItems: '已删除邮件',
