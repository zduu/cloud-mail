...
const requirePerms = [
	...
	'/preview/list',
	'/preview/expire',
	'/email/preview/create',
	'/email/preview/list',
	'/email/preview/delete',
	'/email/preview/expire',
	'/user/delete',
	'/user/setPwd',
	'/user/setStatus',
	'/user/setType',
...
const premKey = {
	...
	'preview:mailbox:create': ['/preview/create','/preview/list'],
	'preview:mailbox:delete': ['/preview/delete','/preview/list'],
	'preview:mailbox:expire': ['/preview/expire','/preview/list'],
	'preview-email:create': ['/email/preview/create','/email/preview/list'],
	'preview-email:delete': ['/email/preview/delete','/email/preview/list'],
	'preview-email:expire': ['/email/preview/expire','/email/preview/list'],
